...
mon.addEventListener('click', function () {dayTracker('monday')});  //[1] Still don't understand why it has to be this way, but it does
tue.addEventListener('click', function () {dayTracker('tuesday')});
wed.addEventListener('click', function () {dayTracker('wednesday')});
thu.addEventListener('click', function () {dayTracker('thursday')});
fri.addEventListener('click', function () {dayTracker('friday')});
...
halfDayButton.addEventListener("click", function() {dayToggle('half' , 'full')})
fullDayButton.addEventListener('click', function() {dayToggle('full' , 'half')})
